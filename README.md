...
*STREAMERS: The AI model requires a 750ms lookahead to work. You MUST delay your webcam/game or app audio/game or app video/anything else by 750ms in OBS (etc.) to keep everything in sync!*
